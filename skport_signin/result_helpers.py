from skport_signin.statuses import ALREADY_DONE, ERROR, SUCCESS


def final_signin_status(
    *,
    day_number: int,
    refreshed_state: str,
    post_seen: bool,
    ...
    if post_seen:
        return (
            ERROR,
            "ERROR: the sign-in POST for "
            f"Day {day_number} returned success, but the refreshed page state "
