...
from skport_signin.commands import doctor as doctor_command
from skport_signin.commands import init as init_command
from skport_signin.commands import package as package_command
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="skport_signin",
        description="Skport_Signin unified CLI for source and packaged Windows workflows.",
    )
    parser.add_argument(
        "--config",
    ...
    parser.add_argument(
        "--base-dir",
        help="Override the Skport_Signin data directory root.",
    )
